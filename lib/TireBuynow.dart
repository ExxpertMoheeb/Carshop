...
class TireBuyNow extends StatefulWidget {
  const TireBuyNow({super.key});

  @override
  State<TireBuyNow> createState() => _TireBuyNowState();
}

class _TireBuyNowState extends State<TireBuyNow> {
  var currentindex = 0;
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                  ...
                  items: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image: AssetImage('asset/BFG_KO2Tire_02@3x.png',),
                ...
                Padding(
                  padding:
                      EdgeInsets.only(left: width * 0.4, top: height * 0.12),
                  child: Row(
                    children: [
                      Container(
                        height: height * 0.01,
