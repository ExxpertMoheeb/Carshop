...
class PowerBrake extends StatefulWidget {
  const PowerBrake({super.key});

  @override
  State<PowerBrake> createState() => _PowerBrakeState();
}

class _PowerBrakeState extends State<PowerBrake> {
  var currentindex=0;
  @override
                  ...
                  items: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image: AssetImage('asset/Rectangle 500@3x.png'),
                        fit: BoxFit.cover,
                      )),
                    ),
                    Container(
